...
async def async_setup_entry(
    ...
    async_add_entities([HydroModeSelect(entry.runtime_data)])


class HydroModeSelect(HydroSettingEntity, RestoreEntity, SelectEntity):
    ...
    def __init__(self, controller: HydroController) -> None:
        ...
        HydroSettingEntity.__init__(self, controller, "mode")
