...
async def async_setup_entry(
    ...
    async_add_entities([HydroIrrigationSwitch(entry.runtime_data)])
...
class HydroIrrigationSwitch(HydroSettingEntity, RestoreEntity, SwitchEntity):
    ...
    def __init__(self, controller: HydroController) -> None:
        ...
        HydroSettingEntity.__init__(self, controller, "irrigation")
